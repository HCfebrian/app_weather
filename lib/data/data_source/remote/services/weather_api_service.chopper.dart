...
class _$WeatherService extends WeatherService {
  ...
  Future<Response> getWeather(String cityName) {
    final $url =
        '/data/2.5/weather?q=${cityName}&appid=aaeb23fa10a2eb31d102b161dfeaae5b&unit=metric';
  ...
  Future<Response> getForecast(String cityName) {
    final $url =
        '/data/2.5/forecast?q=${cityName}&appid=aaeb23fa10a2eb31d102b161dfeaae5b&unit=metric';
    final $request = Request('GET', $url, client.baseUrl);
    return client.send<dynamic, dynamic>($request);
  }
}
